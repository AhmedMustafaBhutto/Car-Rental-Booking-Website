          ...
          <Row>
            ...
            <Col lg="3" md="4" sm="6">
              <div className="mb-4">
                ...
                <p className="head__office">Phone: +92 30534 68728 </p>
                <p className="head__office">Email: example@gmail.com</p>
                <p className="head__office">Office Time: 9am - 5pm</p>
              </div>
            </Col>
            ...
            <Col>
              <div className="footer__bottom">
                <p className="section__description pt-4 fw-bold text-center d-flex align-items-center justify-content-center gap-1">
                  ...
                  <span>Rehan Ramzan & Umair Oriakheil</span>. All Rights Reserved
                </p>
              </div>
            </Col>
          </Row>
